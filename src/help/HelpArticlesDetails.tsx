              ...
              <div className="w-full md:w-3/4">
                ...
                <div className="mt-4">
                  {(article.features as any[]).map((feature: any, index: number) => (
                    feature.isHeading ? (
                      ...
                      <div
                        key={index}
                        className="article-content text-gray-700 mb-4 mt-4 leading-relaxed"
                        dangerouslySetInnerHTML={{
                ...
                >
                  ...
                  <div className="mt-3 flex gap-4">
                    <button
                      className={`text-3xl hover:cursor-pointer transition-all ${selectedEmoji === 'happy'
                    ...
                    <button
                      className={`text-3xl hover:cursor-pointer transition-all ${selectedEmoji === 'neutral'
                          ? 'opacity-100 scale-125'
                          : selectedEmoji
                            ? 'opacity-50 hover:opacity-75 hover:scale-125'
                            : 'opacity-100 hover:scale-125'
                    ...
                    <button
                      className={`text-3xl hover:cursor-pointer transition-all ${selectedEmoji === 'sad'
                          ? 'opacity-100 scale-125'
                          : selectedEmoji
                            ? 'opacity-50 hover:opacity-75 hover:scale-125'
                            : 'opacity-100 hover:scale-125'
                  ...
                  <ul className="mt-4 space-y-2 ml-4" ref={listRef}>
                    {(() => {
                      ...
                      return tocSections.map(({ id, label }) => (
                        <li key={id}>
                          <button
                            className={`block w-full text-left py-1 pl-4 transition-all cursor-pointer ${activeSection === id ? 'text-black font-semibold' : 'text-gray-700'
                              }`}
                            onClick={() => {
